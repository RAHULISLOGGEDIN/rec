  ...
  function submitForm(e) {
    ...
    if (formData.fullname.value.length < 3) {
      ...
      setFormData((prevState) => ({
        ...
        fullname: {
          ...prevState.fullname,
          error: "The name should be greater than 3",
        },
      }));
    }
    if (parseInt(formData.age.value) < 18) {
      ...
      setFormData((prevState) => ({
        ...
        age: {
          ...prevState.age,
          error: "The age should be greater than 18 or equal to 18",
        },
      }));
        ...
        <div style={{ display: "flex" }}>
          ...
          <div>
            ...
            {formData.fullname.error ? (
              <div className="errorField">*{formData.fullname.error}</div>
            ) : null}
          </div>
        </div>
        <div style={{ display: "flex" }}>
          ...
          <div>
            ...
            />
            {formData.age.error ? (
              <div className="errorField">*{formData.age.error}</div>
            ) : null}
          </div>
        </div>
        <div style={{ display: "flex" }}>
          ...
          <div>
            ...
            {formData.email.error ? (
              <div className="errorField">*{formData.email.error}</div>
            ) : null}
          </div>
        </div>
